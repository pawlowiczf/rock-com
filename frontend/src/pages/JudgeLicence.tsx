        ...
        <div className="auth-form">
          <form>
            {licences.map((licence, index) => (
              ...
              >
                <div className="discipline-buttons" style={{ display: "flex", gap: "15px" }}>
                  {disciplineOptions.map((option) => (
                    <button
                      key={option.value}
                      type="button"
                      onClick={() => updateLicence(index, "discipline", option.value)}
                ...
                <input
                  ...
                  onChange={(e) =>
                    updateLicence(index, "licenceNumber", e.target.value)
                  }
                />
